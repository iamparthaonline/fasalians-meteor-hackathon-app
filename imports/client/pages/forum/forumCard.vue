  ...
  <v-card outlined :loading="loading" class="ma-3">
    ...
    <div class="d-flex mx-2">
      <v-row align="center">
        ...
        <v-btn class="my-4 ml-2" text icon color="black lighten-2" @click="sharePost">
...
<script>
  export default {
    ...
    methods: {
      ...
      sharePost() {
        return window.plugins.socialsharing.share(`https://agrisquad.meteorapp.com/post/${this.post._id}`);
      },
    },
  };
</script>
